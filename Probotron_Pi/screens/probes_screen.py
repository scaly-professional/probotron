...
# Probes for encounter 1
class ProbesScreen( BaseScreen ):
    
    def __init__(self, screen, config, probes ):

        self._probes = probes
        super(ProbesScreen, self).__init__( screen, config )
        
    
    def setup( self ):
        
        super( ProbesScreen, self ).setup()
    ...
    def forward( self ):
        ...
        super( ProbesScreen, self ).forward()
    ...
    def select( self ):
        ...
        super( ProbesScreen, self ).select()
    ...
    def _render_current_probe(self):
        ...
        header_str = "First Encounter"
        text_str = self._probes.get_probe_text(0)
