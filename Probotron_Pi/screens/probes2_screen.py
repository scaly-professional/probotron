...
# Probe screen for the second encounter
class Probes2Screen( BaseScreen ):
    
    def __init__(self, screen, config, probes ):

        self._probes = probes
        super(Probes2Screen, self).__init__( screen, config )
        
    
    def setup( self ):
        
        super( Probes2Screen, self ).setup()
    ...
    def reset( self ):
        super( Probes2Screen, self ).reset()
    ...
    def forward( self ):
        ...
        super( Probes2Screen, self ).forward()
    ...
    def select( self ):
        ...
        super( Probes2Screen, self ).select()
    ...
    def _render_current_probe(self):
        ...
        header_str = "Second Encounter"
        text_str = self._probes.get_probe_text(1)
